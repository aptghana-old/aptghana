          ...
          {SOLUTIONS.map((sol) => (
            ...
            >
              <div className="grid sm:grid-cols-[1fr_auto] gap-4 items-start">
                <div>
                  <div className="w-2 h-8 rounded-full mb-3 inline-block" style={{ backgroundColor: sol.accent }} />
                  <h2 className="text-xl font-bold text-[#0a1628] group-hover:text-[#0057b8] transition-colors mb-1">{sol.name}</h2>
                  <p className="text-sm font-semibold mb-2" style={{ color: sol.accent }}>{sol.headline}</p>
