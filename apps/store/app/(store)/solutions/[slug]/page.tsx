          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start mb-10">
            ...
            <div className="bg-white rounded-2xl border border-[#e5e7eb] p-7">
              ...
              <ul className="space-y-2">
                {sol.products.map((p) => (
                  <li key={p}>
                    <Link href={`/products?solution=${slug}&q=${encodeURIComponent(p)}`} className="flex items-center justify-between p-3 rounded-xl hover:bg-[#f9fafb] border border-transparent hover:border-[#e5e7eb] transition-all group">
              ...
              <div className="mt-4 pt-4 border-t border-[#e5e7eb]">
                <Link href={`/products?solution=${slug}`} className="inline-flex items-center gap-2 text-sm font-semibold text-[#0057b8] hover:text-[#1a73e8] transition-colors">
