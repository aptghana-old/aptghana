        ...
        <div className="container-store py-10">
          {products.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center bg-white rounded-2xl border border-[#e5e7eb]">
              ...
              <Link href="/products" className="inline-flex items-center gap-2 h-11 px-7 bg-[#0057b8] hover:bg-[#1a73e8] text-white font-semibold text-sm rounded-xl transition-colors">
                Browse All Products
              </Link>
            </div>
          ) : (
