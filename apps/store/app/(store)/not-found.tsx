    ...
    <>      <main className="min-h-screen bg-[#f9fafb] flex items-center">
        <div className="container-store py-20 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/" className="inline-flex items-center gap-2 h-11 px-6 bg-[#0057b8] hover:bg-[#1a73e8] text-white font-semibold text-sm rounded-xl transition-colors">
              Go Home
            </Link>
            <Link href="/products" className="inline-flex items-center gap-2 h-11 px-6 border border-[#d1d5db] hover:border-[#0057b8] text-[#374151] hover:text-[#0057b8] font-semibold text-sm rounded-xl transition-colors">
              Browse Products
            </Link>
