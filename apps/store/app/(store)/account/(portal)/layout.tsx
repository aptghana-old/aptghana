  ...
  return (
    <aside className="w-64 shrink-0 hidden lg:flex flex-col">
      <div className="sticky top-6 space-y-1">
        ...
        {/* Store link */}
        <Link href="/products" className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium text-(--text-3) hover:bg-(--bg-raised) hover:text-(--text-1) transition-colors">
